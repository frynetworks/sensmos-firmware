...
uint32_t mesh_node_num() {
    // FICR DEVICEADDR is the same source identity.cpp uses for the device id, so a
    // node's mesh address and its SENSMOS id stay tied to the same silicon.
